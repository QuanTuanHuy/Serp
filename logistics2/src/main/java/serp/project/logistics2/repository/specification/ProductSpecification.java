package serp.project.logistics2.repository.specification;
...
public class ProductSpecification {
    ...
    public static Specification<ProductEntity> satisfy(String _query, String categoryId, String statusId,
            Long tenantId) {
