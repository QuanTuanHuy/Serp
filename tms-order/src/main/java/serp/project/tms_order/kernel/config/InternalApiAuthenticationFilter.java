...
public class InternalApiAuthenticationFilter extends OncePerRequestFilter {
    ...
    private static final String PAYMENT_WEBHOOK_PATH = "/api/v1/internal/payment-webhooks/";
    ...
    private boolean requiresInternalApiKey(HttpServletRequest request) {
        ...
        return requestUri != null
                && requestUri.contains(INTERNAL_PATH_MARKER)
                && !requestUri.contains(PAYMENT_WEBHOOK_PATH);
    }
