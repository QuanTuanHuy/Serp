...
type INotificationPort interface {
	...
	GetList(ctx context.Context, params any) ([]*entity.NotificationEntity, int64, error)
	...
	UpdateAllUnread(ctx context.Context, tx *gorm.DB, userID int64, updates map[string]any) error
