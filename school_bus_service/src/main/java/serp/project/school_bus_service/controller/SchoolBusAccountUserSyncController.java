...
public class SchoolBusAccountUserSyncController {
     ...
     */
    @PostMapping("/sync")
    @PreAuthorize("@roleAuthorizer.hasPermission('school-bus.account-user-sync.execute')")
    ...
    @PreAuthorize("@roleAuthorizer.hasPermission('school-bus.account-user-sync.read')")
