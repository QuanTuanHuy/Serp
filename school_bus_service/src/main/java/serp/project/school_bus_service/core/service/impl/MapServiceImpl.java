...
public class MapServiceImpl implements IMapService {
    ...
    public List<MapLocationResponse> geocode(String query) {
        if (!StringUtils.hasText(query)) {
            throw new AppException(AppErrorCode.INVALID_REQUEST, "Search query is required");
        }
    ...
    public MapLocationResponse reverseGeocode(Double latitude, Double longitude) {
        if (latitude == null || longitude == null) {
            throw new AppException(AppErrorCode.INVALID_REQUEST, "Latitude and longitude are required");
        }
        ...
        try {
            ...
            if (response == null || response.isNull()) {
                throw new AppException(AppErrorCode.NOT_FOUND, "No address found for the selected location");
            }
