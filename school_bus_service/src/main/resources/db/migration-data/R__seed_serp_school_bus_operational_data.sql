...
VALUES
    ('RTE000001', 'Tuyến mầm non khu Tây - chiều đi học',
    ...
    ('RTE000002', 'Tuyến mầm non khu Tây - chiều về nhà',
    ...
    ('RTE000005', 'Tuyến tiểu học khu Tây - chiều về nhà',
    ...
    ('RTE000006', 'Tuyến tiểu học khu trung tâm - chiều về nhà',
     'SBU000002', 'RETURN', date '2026-06-22', 'PUBLISHED', 'TRIP_CREATED',
    ...
    ('RTE000007', 'Tuyến THCS khu Tây - chiều đi học',
    ...
    ('RTE000008', 'Tuyến THCS khu Đông - chiều đi học',
    ...
    ('RTE000011', 'Tuyến tiểu học khu Đông - chiều đi học',
    ...
    ('RTE000012', 'Tuyến THCS khu Bắc - chiều về nhà',
...
SELECT
    ...
    CASE definition.session_status
        WHEN 'PUBLISHED' THEN 'Kế hoạch đưa đón ngày thường đã được phê duyệt.'
        WHEN 'REVIEWING' THEN 'Phân bổ tuyến đang được bộ phận vận hành rà soát.'
        ELSE 'Bộ phận vận tải đang chuẩn bị phân bổ tuyến.'
    END,
...
SELECT
    ...
    'Tuyến thường kỳ được lập từ các đăng ký học sinh đang hoạt động.',
    NULL,
    NULL,
