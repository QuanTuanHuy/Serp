...
func (c *CategoryService) CreateCategory(ctx context.Context, req map[string]interface{}) (*response.BaseResponse, error) {
...
func (c *CategoryService) UpdateCategory(ctx context.Context, categoryId string, req map[string]interface{}) (*response.BaseResponse, error) {
