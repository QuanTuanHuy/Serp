...
func (a *AddressService) CreateAddress(ctx context.Context, req map[string]interface{}) (*response.BaseResponse, error) {
...
func (a *AddressService) UpdateAddress(ctx context.Context, addressId string, req map[string]interface{}) (*response.BaseResponse, error) {
