...
public record BagDistributionManifestResponse(
        ...
        @JsonProperty("driver_start_checkin_id") Long driverStartCheckinId,
        ...
        @JsonProperty("driver_start_location_label") String driverStartLocationLabel,
        @JsonProperty("driver_start_photo_url") String driverStartPhotoUrl,
        @JsonProperty("driver_end_checkin_id") Long driverEndCheckinId,
        ...
        @JsonProperty("driver_end_location_label") String driverEndLocationLabel,
