package serp.project.tms_billing_service.exception;
...
public enum ErrorCode {
    ...
    BILLING_RULE_NOT_FOUND(9435, "error.9435", HttpStatus.BAD_REQUEST),
    LOCATION_NOT_FOUND(9436, "error.9436", HttpStatus.BAD_REQUEST),
    WEIGHT_LIMIT_EXCEEDED(9437, "error.9437", HttpStatus.BAD_REQUEST),
    // Lỗi khác (99xx)
