...
export SERVER_PORT="${SERVER_PORT:-8104}"
export DB_URL="${DB_URL:-jdbc:postgresql://localhost:5432/tms-billing-service}"
...
echo ""
echo "Starting TMS Billing Service in development mode..."
