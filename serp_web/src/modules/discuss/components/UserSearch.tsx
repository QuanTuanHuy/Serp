              ...
              <div className="flex flex-wrap gap-1 items-center">
                {mode === 'single' ? (
                  ...
                  <span className="truncate">
                    {users.find(u => u.id === selectedUserIds[0])?.name || selectedUserIds[0]}
                  </span>
                ) : (
                ...
                >
                  <div className="flex items-center gap-3 w-full">
                    <Avatar className="h-8 w-8">
                      ...
                      <AvatarFallback className={cn("text-xs text-white font-medium bg-gradient-to-br", getAvatarColor(user.name))}>
