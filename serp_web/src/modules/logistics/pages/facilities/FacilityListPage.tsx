// Logistics FacilityListPage Component (authors: QuanTuanHuy, Description: Part of Serp Project)
  ...
  return (
    <div className={cn('space-y-6', className)}>
      ...
      <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4'>
        ...
        <Button
          onClick={() => router.push('/logistics/facility/new')}
          className='gap-2'
        >
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
          {facilities.map((facility: Facility) => (
            <FacilityCard
              key={facility.id}
              facility={facility}
              onClick={() => router.push(`/logistics/facility/${facility.id}`)}
              onEdit={() =>
                router.push(`/logistics/facility/${facility.id}/edit`)
              }
        ...
        <Card>
          <CardContent className='py-16 text-center'>
            ...
            {hasActiveFilters ? (
              ...
              <Button onClick={() => router.push('/logistics/facility/new')}>
