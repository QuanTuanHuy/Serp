...
export function DriverRoutesPage() {
  ...
  if (!isDriver && user !== null) {
    return (
      <AccessDenied
        ...
        title='Access Denied'
        description="You don't have the TTCRS_DRIVER role required to access this page."
        variant='minimal'
        size='md'
        showBackButton
        showHomeButton
  ...
  return (
    <div className='flex flex-col gap-6 px-12 py-6'>
      {/* Header */}
      <div>
        <h1 className='text-2xl font-bold tracking-tight'>My Truck Routes</h1>
