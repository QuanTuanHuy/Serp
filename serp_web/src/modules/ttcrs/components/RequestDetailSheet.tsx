...
export function RequestDetailSheet({
  ...
  const [updateStatus, { isLoading: isCancelling }] = useUpdateDispatcherRequestsStatusMutation();
          ...
          <SheetHeader className='px-6 py-4 border-b'>
            <div className='flex flex-col gap-1 pr-8'>
              ...
              <div className='flex items-center gap-2'>
                ...
                <Badge className={cn('rounded-full px-2.5 py-0.5 text-xs font-medium', STATUS_CLASS[request.status])}>
          ...
          <div className='flex-1 overflow-y-auto px-6 py-5 space-y-5'>
            ...
            <div className='space-y-1'>
              ...
              <p className='text-sm text-foreground'>
                {customerName || (request.customerId ? `Customer #${request.customerId}` : '—')}
              </p>
            </div>
            ...
            <div className='grid grid-cols-2 gap-4'>
              <div className='space-y-1.5'>
                ...
                {isPending ? (
                  ...
                  <Input value={srcLocationCode} readOnly className='bg-muted/40 text-muted-foreground' />
                )}
              </div>
              <div className='space-y-1.5'>
                ...
                {isPending ? (
                  ...
                  <Input value={destLocationCode} readOnly className='bg-muted/40 text-muted-foreground' />
                )}
              </div>
            </div>
            ...
            {!isPending && (
              <div className='rounded-md bg-muted/50 px-4 py-3 text-xs text-muted-foreground'>
                This request is <strong>{request.status.replace('_', ' ')}</strong> and cannot be edited.
              </div>
            )}
            ...
            <div className='grid grid-cols-2 gap-3 text-sm'>
              <div>
                <p className='text-xs text-muted-foreground uppercase tracking-wider mb-0.5'>Created at</p>
              ...
              {request.transportPlanId && (
                <div>
                  <p className='text-xs text-muted-foreground uppercase tracking-wider mb-0.5'>Transport Plan</p>
      ...
      <AlertDialog open={cancelOpen} onOpenChange={setCancelOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {formatId(request.id)} will be marked as <strong>Cancelled</strong>. This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
