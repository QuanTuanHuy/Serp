    ...
    <>
      ...
      >
        ...
        <div className='grid gap-6 xl:grid-cols-[1.2fr_0.8fr]'>
          <SchoolBusSection
            title='Route map'
            description='School hub, planned stops, and the ordered route polyline.'
          >
            <RouteMap route={detail.route} stops={detail.stops} />
          </SchoolBusSection>

          <SchoolBusSection
            title='Planned stops'
            description='Stops generated by the current planning workflow.'
          >
                ...
                <TableBody>
                  {detail.stops.map((stop) => (
                    <TableRow key={stop.id}>
                      ...
                      <TableCell>{stop.estimatedStudentCount ?? 0}</TableCell>
                      <TableCell>{stop.plannedArrivalTime || 'N/A'}</TableCell>
                      <TableCell>{stop.plannedDepartureTime || 'N/A'}</TableCell>
                    </TableRow>
                  ))}
                </TableBody>
                </Table>
