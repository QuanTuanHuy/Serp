  ...
  if (access.isDriver || access.isAttendant) {
    return (
      <SchoolBusPageShell
        ...
        description={
          access.isDriver
            ? 'Manage your assigned trips and execute routes.'
            : 'Manage student attendance manifest on assigned trips.'
        }
        breadcrumb={
          <SchoolBusBreadcrumb
            items={[
                    ...
                    ? [
                        {
                          ...
                          title: 'Plan routes',
                          description:
                            'Open the session-based route planning workspace.',
                        },
                      ]
                    : []),
                  // Attendance is managed inside trip operation details.
                  ...(access.canMarkAttendance
                    ? [
                        {
                          href: '/school-bus/trips',
                          title: 'Open trip operations',
                          description:
                            'Choose an assigned trip to record attendance.',
                        },
                      ]
                    : []),
                  // Driver quick action
                    ...
                    ? [
                        {
                          ...
                          title: 'Trips Today',
                          description:
                            'View and operate trips assigned to you.',
                        },
                      ]
                    : []),
                  // Parent quick action
