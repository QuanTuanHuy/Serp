/*
Author: QuanTuanHuy
Description: Part of Serp Project - Logistics2 header
*/
...
interface Logistics2HeaderProps {
  className?: string;
...
export const Logistics2Header: React.FC<Logistics2HeaderProps> = ({
  ...
  const handleSearch = (event: React.FormEvent) => {
    ...
    router.push(
      `/logistics2/delivery-plans?search=${encodeURIComponent(searchQuery.trim())}`
    );
  };
      ...
      <div className='flex h-16 items-center px-4 gap-4'>
        ...
        >
          <div className='relative w-full'>
            ...
            <Input
              type='search'
              placeholder='Search delivery plans, vehicles...'
        ...
        <div className='flex items-center gap-2'>
          ...
          <div className='relative'>
            ...
            {showUserMenu && (
              <div className='absolute right-0 mt-2 w-52 rounded-md bg-popover p-1 shadow-lg border z-50'>
                <Link href='/profile'>
