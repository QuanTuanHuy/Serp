        ...
        <form onSubmit={handleSubmit} className='space-y-4'>
          <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
            <div className='space-y-2 md:col-span-2'>
              ...
              <Input id='quick-name' value={formData.name} onChange={(e) => setFormData((prev) => ({ ...prev, name: e.target.value }))} required />
            </div>
            <div className='space-y-2'>
              <Label htmlFor='quick-email'>Email</Label>
              <Input id='quick-email' type='email' value={formData.email} onChange={(e) => setFormData((prev) => ({ ...prev, email: e.target.value }))} required />
            </div>
            <div className='space-y-2'>
              <Label htmlFor='quick-phone'>Phone</Label>
              <Input id='quick-phone' value={formData.phone} onChange={(e) => setFormData((prev) => ({ ...prev, phone: e.target.value }))} />
            </div>
            <div className='space-y-2'>
              <Label htmlFor='quick-company'>Company</Label>
              <Input id='quick-company' value={formData.company} onChange={(e) => setFormData((prev) => ({ ...prev, company: e.target.value }))} />
            </div>
            <div className='space-y-2'>
              <Label htmlFor='quick-jobTitle'>Job Title</Label>
              <Input id='quick-jobTitle' value={formData.jobTitle} onChange={(e) => setFormData((prev) => ({ ...prev, jobTitle: e.target.value }))} />
            </div>
            <div className='space-y-2'>
            ...
            <div className='space-y-2 md:col-span-2'>
              ...
              <Textarea id='quick-notes' rows={3} value={formData.notes} onChange={(e) => setFormData((prev) => ({ ...prev, notes: e.target.value }))} />
            </div>
          </div>
          <DialogFooter>
