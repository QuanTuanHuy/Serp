...
@OpenAPIDefinition(info = @Info(title = "Sales Module API", version = "0.0.1", description = "API documentation for Sales Module"), security = @SecurityRequirement(name = "Bearer Authentication"))
