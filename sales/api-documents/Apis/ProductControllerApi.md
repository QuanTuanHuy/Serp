...
|------------- | ------------- | -------------|
| [**createProduct**](ProductControllerApi.md#createProduct) | **POST** /sales/api/v1/product/create |  |
| [**deleteProduct**](ProductControllerApi.md#deleteProduct) | **DELETE** /sales/api/v1/product/delete/{productId} |  |
| [**getProduct**](ProductControllerApi.md#getProduct) | **GET** /sales/api/v1/product/search/{productId} |  |
| [**getProducts**](ProductControllerApi.md#getProducts) | **GET** /sales/api/v1/product/search |  |
| [**updateProduct**](ProductControllerApi.md#updateProduct) | **PATCH** /sales/api/v1/product/update/{productId} |  |
