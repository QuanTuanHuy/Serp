...
|------------- | ------------- | -------------|
| [**createInventoryItem**](InventoryItemControllerApi.md#createInventoryItem) | **POST** /sales/api/v1/inventory-item/create |  |
| [**deleteInventoryItem**](InventoryItemControllerApi.md#deleteInventoryItem) | **DELETE** /sales/api/v1/inventory-item/delete/{inventoryItemId} |  |
| [**searchInventoryItem**](InventoryItemControllerApi.md#searchInventoryItem) | **GET** /sales/api/v1/inventory-item/search/{inventoryItemId} |  |
| [**searchInventoryItems**](InventoryItemControllerApi.md#searchInventoryItems) | **GET** /sales/api/v1/inventory-item/search |  |
| [**updateInventoryItem**](InventoryItemControllerApi.md#updateInventoryItem) | **PATCH** /sales/api/v1/inventory-item/update/{inventoryItemId} |  |
...
|------------- | ------------- | ------------- | -------------|
| **InventoryItemCreationForm** | [**InventoryItemCreationForm**](../Models/InventoryItemCreationForm.md)|  | [optional] |
...
|------------- | ------------- | ------------- | -------------|
| **inventoryItemId** | **String**|  | [default to null] |
| **InventoryItemUpdateForm** | [**InventoryItemUpdateForm**](../Models/InventoryItemUpdateForm.md)|  | [optional] |
