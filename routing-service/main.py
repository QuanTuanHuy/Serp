...
def create_producer():
    ...
    while True:
        try:
            print(f"[*] Đang kết nối Kafka Producer tới {KAFKA_BROKER}...")
            ...
            print("[+] Kafka Producer kết nối thành công!")
            return producer
        except Exception as e:
            print(f"[!] Lỗi kết nối Producer: {e}. Thử lại sau 5 giây...")
...
def create_consumer():
    ...
    while True:
        try:
            print(f"[*] Đang kết nối Kafka Consumer tới {KAFKA_BROKER}...")
            ...
            print("[+] Kafka Consumer kết nối thành công!")
            return consumer
        except Exception as e:
            print(f"[!] Lỗi kết nối Consumer: {e}. Thử lại sau 5 giây...")
            time.sleep(5)

def main():
    print("=== KHỞI ĐỘNG ROUTING SERVER ===")
    ...
    while True:
        try:
            ...
            print(f"[*] Đang lắng nghe trên topic: {INPUT_TOPIC}...\n")
            ...
            for message in consumer:
                try:
                    ...
                    print(f"[->] Bắt đầu xử lý Plan ID: {plan_id}")
