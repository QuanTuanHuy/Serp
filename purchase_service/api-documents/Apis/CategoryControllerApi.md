...
|------------- | ------------- | -------------|
| [**createCategory**](CategoryControllerApi.md#createCategory) | **POST** /purchase-service/api/v1/category/create |  |
| [**deleteCategory**](CategoryControllerApi.md#deleteCategory) | **DELETE** /purchase-service/api/v1/category/delete/{categoryId} |  |
| [**getCategories**](CategoryControllerApi.md#getCategories) | **GET** /purchase-service/api/v1/category/search |  |
| [**getCategory**](CategoryControllerApi.md#getCategory) | **GET** /purchase-service/api/v1/category/search/{categoryId} |  |
| [**updateCategory**](CategoryControllerApi.md#updateCategory) | **PATCH** /purchase-service/api/v1/category/update/{categoryId} |  |
