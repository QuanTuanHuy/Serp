...
public class RoleActorOutboxPublisher {

    private final IOutboxEventService outboxEventService;
    private final JsonUtils jsonUtils;

    public void publishRoleActorAdded(Long tenantId, RoleActorEventPayload payload) {
        saveOutboxEvent(tenantId, payload, EventConstants.Project.EventType.ROLE_ACTOR_ADDED);
    }

    public void publishRoleActorRemoved(Long tenantId, RoleActorEventPayload payload) {
        saveOutboxEvent(tenantId, payload, EventConstants.Project.EventType.ROLE_ACTOR_REMOVED);
    }

    private void saveOutboxEvent(Long tenantId,
                                 RoleActorEventPayload payload,
                                 String eventType) {
