...
public enum ErrorCode {
    ...
    POST_OFFICE_STAFF_ASSIGNMENT_NOT_FOUND(9420, "error.9420", HttpStatus.NOT_FOUND),
    NO_SUITABLE_ORIGIN_POST_OFFICE(9421, "error.9421", HttpStatus.BAD_REQUEST),
    NO_SUITABLE_DESTINATION_POST_OFFICE(9424, "error.9424", HttpStatus.BAD_REQUEST),
    ...
    // Delivery last-mile errors (95xx)
    DELIVERY_MANIFEST_NOT_FOUND(9501, "error.9501", HttpStatus.NOT_FOUND),
    DELIVERY_MANIFEST_INVALID_STATUS(9502, "error.9502", HttpStatus.BAD_REQUEST),
    DELIVERY_ORDER_INVALID_STATUS(9503, "error.9503", HttpStatus.BAD_REQUEST),
    POST_OFFICE_LOCATION_NOT_SET(9504, "error.9504", HttpStatus.BAD_REQUEST),
    DELIVERY_MAX_ATTEMPTS_EXCEEDED(9505, "error.9505", HttpStatus.BAD_REQUEST),
