...
public final class PostOfficeSpecification {

    private PostOfficeSpecification() {
    }

    public static Specification<PostOffice> byFilter(Long tenantId, PostOfficeFilterRequest filterRequest) {
        return (root, query, criteriaBuilder) -> {
            ...
            if (filterRequest.getMaxServiceRadiusM() != null) {
                predicates.add(criteriaBuilder.le(root.get("serviceRadiusM"), filterRequest.getMaxServiceRadiusM()));
            }
            ...
            if (filterRequest.getMaxPriority() != null) {
