...
{\textbf{\Large{Thiết kế xây dựng hệ thống quản lý giao vận ba chặng}}\\[1cm]

{\textbf{\large{NGUYỄN THẾ ANH}}}\\
{\large{anh.nt224921@sis.hust.edu.vn}}\\[0.5cm]
...
\resizebox{\textwidth}{!}{%
\begin{tabular}{ll}
\multicolumn{1}{c}{\textbf{Giảng viên hướng dẫn:}} & TS. Phạm Quang Dũng \hspace{0.5cm} \underline{\hspace{3cm}}  \\[0.5cm]
