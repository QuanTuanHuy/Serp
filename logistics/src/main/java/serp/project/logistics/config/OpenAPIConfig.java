...
@OpenAPIDefinition(info = @Info(title = "Warehouse Module API", version = "0.0.1", description = "API documentation for Warehouse Module"), security = @SecurityRequirement(name = "Bearer Authentication"))
