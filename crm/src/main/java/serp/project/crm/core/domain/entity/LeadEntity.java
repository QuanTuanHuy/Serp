...
public class LeadEntity extends BaseEntity {
    ...
    /**
     * Update lead fields from another lead (for PATCH operations)
     */
    public void updateFrom(LeadEntity updates) {
        ...
        if (updates.getCompany() != null) this.company = updates.getCompany();
        if (updates.getJobTitle() != null) this.jobTitle = updates.getJobTitle();
        if (updates.getLeadSource() != null) this.leadSource = updates.getLeadSource();
        if (updates.getIndustry() != null) this.industry = updates.getIndustry();
        if (updates.getCompanySize() != null) this.companySize = updates.getCompanySize();
        if (updates.getEstimatedValue() != null) this.estimatedValue = updates.getEstimatedValue();
        if (updates.getLeadStatus() != null) this.leadStatus = updates.getLeadStatus();
        if (updates.getAssignedTo() != null) this.assignedTo = updates.getAssignedTo();
        if (updates.getWebsite() != null) this.website = updates.getWebsite();
