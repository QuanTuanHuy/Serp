...
public class MilpSchedulerTest {
    ...
    private static boolean anyOverlap(PlanResult res) {
        ...
        var byDate = new java.util.HashMap<Long, java.util.List<serp.project.ptm_optimization.infrastructure.algorithm.dto.output.Assignment>>();
        for (var a : list)
        ...
        for (var e : byDate.entrySet()) {
            ...
            L.sort(java.util.Comparator.comparingInt(
                    serp.project.ptm_optimization.infrastructure.algorithm.dto.output.Assignment::getStartMin));
